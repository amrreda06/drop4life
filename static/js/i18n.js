  ...
  const STRINGS = {
    ar: {
      ...
      chat: {
        ...
        view: 'مشاهدة',
        delete: 'حذف الرسالة',
        deleteConfirm: 'هل تريد حذف هذه الرسالة من النظام؟',
        seenBy: 'شوهد بواسطة:',
      ...
      toast: {
        ...
        messageDeleted: '🗑️ تم حذف الرسالة', messageDeletedBody: 'تم حذف الرسالة المحددة من النظام.',
    ...
    en: {
      ...
      chat: {
        ...
        deleteConfirm: 'Delete this message from the system?',
        seenBy: 'Seen by:',
      ...
      toast: {
        ...
        messageDeleted: '🗑️ Message deleted', messageDeletedBody: 'The selected message was removed from the system.',
